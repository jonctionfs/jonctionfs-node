...
export class Client {
  ...
  async presignedGetObject(bucket: string, path: string): Promise<string> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/presignedGetObject", {
      method: "POST",
      headers: {
  ...
  async removeObject(bucket: string, path: string): Promise<void> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/removeObject", {
      method: "POST",
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
  ...
  async presignedPutObject(bucket: string, path: string, expiry: number): Promise<string> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/presignedPutObject", {
      method: "POST",
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
  ...
  async putObject(bucket: string, path: string, object: any): Promise<void> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/putObject", {
      method: "POST",
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
  ...
  async listObjectsV2(bucket: string, path: string, recursive = false): Promise<any> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/listObjectsV2", {
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
        useSSL: String(false),
  ...
  async listBuckets(): Promise<any> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/listBuckets", {
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
        useSSL: String(false),
  ...
  async removeObjects(bucket: string, path: string[]): Promise<void> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/removeObjects", {
      method: "POST",
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
  ...
  async copyObject(bucket: string, newPath: string, oldPath: string): Promise<void> {
    const res = await fetch(process.env.MINIO_SERVER_URI + "/copyObject", {
      method: "POST",
      headers: {
        endPoint: this.#endPoint,
        port: "9000",
